...
export const artistsLabelsOnboardingStyles = {
  ...
  cta: {
    ...
    secondaryButton: [
      ...
      'h-11 sm:h-12 px-5 sm:px-6 rounded-lg w-full sm:w-auto',
      'bg-theme-page text-accent-600 dark:text-accent-400 text-sm font-semibold',
      ...
      'motion-reduce:hover:translate-y-0',
      'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-page-bg)]',
